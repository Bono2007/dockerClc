  ...
  $.fn.transition = $.fn.transit = function(properties, duration, easing, callback) {
    ...
    var run = function(nextCall, element) {
      ...
      var cb = function(e) {
        ...
        if (bound) { self.unbind("transitionend transitionEnd oTransitionEnd webkitTransitionEnd MsTransitionEnd", cb); }
      ...
      if ( (transitionEnd) && ($.transit.useTransitionEnd)) {
        ...
        bound = true;
        self.bind("transitionend transitionEnd oTransitionEnd webkitTransitionEnd MsTransitionEnd", cb);
      } else {
  ...
  $.fn.transitionStop = $.fn.transitStop = function(clearQueue, jumpToEnd){
    this.each(function() {
      ...
      if(properties){
        ...
        if(clearQueue){
          self.clearQueue();
          self.unbind("transitionend transitionEnd oTransitionEnd webkitTransitionEnd MsTransitionEnd");
        };
